...
import * as ViewModeManager from "./viewModeManager.js?v=20260309-achievements-view-fix-1";
import * as ShareManager from "./shareManager.js?v=20260305-share-fallback-1";
import { bindModalOverlayQuickClose } from "./shareManager.js?v=20260305-share-fallback-1";
...
import * as AuthManager from "./authManager.js?v=20260309-request-directory-1";
...
import { initAuthLifecycle } from "./authLifecycle.js?v=20260309-logout-loader-cover-1";
import { initOnboardingUI } from "./onboardingUI.js";
import { handleProfileLink } from "./routeManager.js?v=20260304-achievements-6k";
import { exitViewMode as runExitViewMode } from "./viewModeExit.js?v=20260309-aeternus-exit-text-1";
import { initProfileModalController } from "./profileModalUI.js?v=20260309-logout-loader-cover-1";
