...
export const I18N = {
    en: {
        ...
        settings_display_title: 'Rank Threshold Visualization',
        settings_threshold_viz: 'Rank Threshold Visualization',
        settings_threshold_viz_note: 'Shows a small rank icon below the threshold cells.',
        ...
        settings_time: 'Time',
        settings_stat: 'Stat',
        filter_label_statistic: 'Statistic',
        ...
        leaderboard_subtitle: 'Friends Only',
        leaderboard_filter_scope: 'Location',
        leaderboard_filter_time: 'Time',
        leaderboard_filter_stat: 'Stat',
        leaderboard_filter_mount: 'Mount',
        leaderboard_scope_worldwide: 'Worldwide',
        leaderboard_scope_country: 'Country',
        leaderboard_platform_all: 'All',
        leaderboard_platform_mobile: 'Mobile',
        leaderboard_platform_pc: 'PC',
        leaderboard_time_all: 'Combined',
        leaderboard_time_5_min: '5 Min',
        leaderboard_time_10_min: '10 Min',
        leaderboard_time_60_min: '60 Min',
        leaderboard_stat_kills: 'Baddy Kills',
        leaderboard_stat_points: 'Baddy Points',
        leaderboard_rank: '#',
        leaderboard_player: 'Player',
        leaderboard_rank_name: 'Rank',
        leaderboard_trophies: 'Placements',
        leaderboard_top_baddy: 'Top Baddy',
        leaderboard_prev: 'Previous',
        leaderboard_next: 'Next',
        leaderboard_summary_friends: 'Friends',
        leaderboard_summary_scope: 'Scope',
        leaderboard_summary_range: 'Range',
        leaderboard_country_hint: 'Uses your current country flag',
        leaderboard_empty_sign_in: 'Sign in to view your friends leaderboard.',
        leaderboard_empty_no_friends: 'Add some friends to start your leaderboard.',
        leaderboard_empty_country_flag: 'Set a country flag in your profile to use the country filter.',
        leaderboard_empty_country_matches: 'No friends match your country flag right now.',
        leaderboard_empty_scores: 'No saved scores found for this filter yet.',
        leaderboard_loading: 'Loading leaderboard...',
        rank_name_unranked: 'Unranked',
        rank_current_label: 'Current Rank',
        rank_name_iron: 'Iron',
        rank_name_bronze: 'Bronze',
        rank_name_silver: 'Silver',
        rank_name_gold: 'Gold',
        rank_name_platinum: 'Platinum',
        rank_name_diamond: 'Diamond',
        rank_name_master: 'Master',
        rank_name_grandmaster: 'Grandmaster',
        rank_name_champion: 'Champion',
        rank_name_paragon: 'Paragon',
        rank_name_stellar: 'Stellar',
        rank_name_celestium: 'Celestium',
        rank_name_aeternus: 'Aeternus',
        ...
        views_label: 'Views',
        stat_most_bk_day: "Most BK's in a day",
        stat_most_pt_day: "Most PT's in a day",
        stat_most_bk_season: "Most BK's in a season",
        stat_highest_bk_streak: 'Highest BK Streak',
    ...
    es: {
        ...
        mount_speed_1: 'Montura 1',
        mount_speed_2: 'Montura 2',
        ...
        settings_display_title: 'Visualización de umbrales de rango',
        settings_threshold_viz: 'Visualización de umbrales de rango',
        settings_threshold_viz_note: 'Muestra un pequeño icono de rango debajo de las celdas de umbral.',
        ...
        filter_label_statistic: 'Estadística',
        ...
        menu_leaderboard: 'Clasificacion',
        leaderboard_title: 'Clasificacion',
        leaderboard_subtitle: 'Solo amigos',
        leaderboard_filter_scope: 'Ubicacion',
        leaderboard_filter_time: 'Tiempo',
        leaderboard_filter_stat: 'Estadistica',
        leaderboard_filter_mount: 'Montura',
        leaderboard_scope_worldwide: 'Global',
        leaderboard_scope_country: 'Pais',
        leaderboard_platform_all: 'Todo',
        leaderboard_platform_mobile: 'Movil',
        leaderboard_platform_pc: 'PC',
        leaderboard_time_all: 'Combinado',
        leaderboard_time_5_min: '5 Min',
        leaderboard_time_10_min: '10 Min',
        leaderboard_time_60_min: '60 Min',
        leaderboard_stat_kills: 'Abates de Baddy',
        leaderboard_stat_points: 'Pontos de Baddy',
        leaderboard_rank: '#',
        leaderboard_player: 'Jugador',
        leaderboard_rank_name: 'Rango',
        leaderboard_trophies: 'Posiciones',
        leaderboard_top_baddy: 'Mejor Baddy',
        leaderboard_prev: 'Anterior',
        leaderboard_next: 'Siguiente',
        leaderboard_summary_friends: 'Amigos',
        leaderboard_summary_scope: 'Alcance',
        leaderboard_summary_range: 'Rango',
        leaderboard_country_hint: 'Usa tu bandera actual de pais',
        leaderboard_empty_sign_in: 'Inicia sesion para ver tu leaderboard de amigos.',
        leaderboard_empty_no_friends: 'Agrega algunos amigos para comenzar tu leaderboard.',
        leaderboard_empty_country_flag: 'Configura una bandera de pais en tu perfil para usar el filtro de pais.',
        leaderboard_empty_country_matches: 'Ningun amigo coincide con tu bandera de pais ahora mismo.',
        leaderboard_empty_scores: 'Todavia no hay puntuaciones guardadas para este filtro.',
        leaderboard_loading: 'Cargando leaderboard...',
        rank_name_unranked: 'Sin rango',
        rank_current_label: 'Rango actual',
        rank_name_iron: 'Hierro',
        rank_name_bronze: 'Bronce',
        rank_name_silver: 'Plata',
        rank_name_gold: 'Oro',
        rank_name_platinum: 'Platino',
        rank_name_diamond: 'Diamante',
        rank_name_master: 'Maestro',
        rank_name_grandmaster: 'Gran Maestro',
        rank_name_champion: 'Campeon',
        rank_name_paragon: 'Paragon',
        rank_name_stellar: 'Estelar',
        rank_name_celestium: 'Celestium',
        rank_name_aeternus: 'Aeternus',
        ...
        views_label: 'Vistas',
        stat_most_bk_day: 'Más BK en un día',
        stat_most_pt_day: 'Más PT en un día',
        stat_most_bk_season: 'Más BK en una temporada',
        stat_highest_bk_streak: 'Racha más alta de BK',
    ...
    'pt-BR': {
        ...
        settings_display_title: 'Visualização dos limites de rank',
        settings_threshold_viz: 'Visualização dos limites de rank',
        settings_threshold_viz_note: 'Mostra um pequeno ícone de rank abaixo das células de limite.',
        ...
        filter_label_statistic: 'Estatística',
        ...
        menu_friends: 'Amigos',
        menu_logout: 'Sair',
        menu_leaderboard: 'Classificacao',
        leaderboard_title: 'Classificacao',
        leaderboard_subtitle: 'Somente amigos',
        leaderboard_filter_scope: 'Localizacao',
        leaderboard_filter_time: 'Tempo',
        leaderboard_filter_stat: 'Estatistica',
        leaderboard_filter_mount: 'Montaria',
        leaderboard_scope_worldwide: 'Global',
        leaderboard_scope_country: 'Pais',
        leaderboard_platform_all: 'Todos',
        leaderboard_platform_mobile: 'Mobile',
        leaderboard_platform_pc: 'PC',
        leaderboard_time_all: 'Combinado',
        leaderboard_time_5_min: '5 Min',
        ...
        leaderboard_rank_name: 'Patente',
        leaderboard_trophies: 'Colocacoes',
        leaderboard_top_baddy: 'Melhor Baddy',
        leaderboard_prev: 'Anterior',
        leaderboard_next: 'Proximo',
        leaderboard_summary_friends: 'Amigos',
        leaderboard_summary_scope: 'Escopo',
        leaderboard_summary_range: 'Faixa',
        leaderboard_country_hint: 'Usa a bandeira atual do seu pais',
        leaderboard_empty_sign_in: 'Entre para ver o leaderboard dos seus amigos.',
        leaderboard_empty_no_friends: 'Adicione alguns amigos para comecar seu leaderboard.',
        leaderboard_empty_country_flag: 'Defina uma bandeira de pais no seu perfil para usar o filtro de pais.',
        leaderboard_empty_country_matches: 'Nenhum amigo corresponde a sua bandeira de pais agora.',
        leaderboard_empty_scores: 'Ainda nao ha pontuacoes salvas para este filtro.',
        leaderboard_loading: 'Carregando leaderboard...',
        rank_name_unranked: 'Sem classificacao',
        rank_current_label: 'Rank atual',
        rank_name_iron: 'Ferro',
        rank_name_bronze: 'Bronze',
        rank_name_silver: 'Prata',
        rank_name_gold: 'Ouro',
        rank_name_platinum: 'Platina',
        rank_name_diamond: 'Diamante',
        rank_name_master: 'Mestre',
        rank_name_grandmaster: 'Grao-Mestre',
        rank_name_champion: 'Campeao',
        rank_name_paragon: 'Paragao',
        rank_name_stellar: 'Estelar',
        rank_name_celestium: 'Celestium',
        rank_name_aeternus: 'Aeternus',
        ...
        mount_speed_1: 'Montaria 1',
        mount_speed_2: 'Montaria 2',
        ...
        stat_most_bk_day: 'Mais BK em um dia',
        stat_most_pt_day: 'Mais PT em um dia',
        stat_most_bk_season: 'Mais BK em uma temporada',
        stat_highest_bk_streak: 'Maior sequência de BK'
    }
};
...
Object.assign(I18N.en, {
    ...
    settings_language_subtext: 'Choose a preferred language',
    settings_toggle_disabled: 'Disabled',
    settings_toggle_enabled: 'Enabled'
});

Object.assign(I18N.es, {
    settings_default_config_startup_note: 'Aplica autom\u00E1ticamente las configuraciones despu\u00E9s de iniciar sesi\u00F3n',
    settings_language_subtext: 'Elige un idioma preferido',
    settings_toggle_disabled: 'Desactivado',
    settings_toggle_enabled: 'Activado'
});

Object.assign(I18N['pt-BR'], {
    settings_default_config_startup_note: 'Aplica automaticamente as configura\u00E7\u00F5es ap\u00F3s o login',
    settings_language_subtext: 'Escolha um idioma de prefer\u00EAncia',
    settings_toggle_disabled: 'Desativado',
    settings_toggle_enabled: 'Ativado'
});
